...
def next_population(population: list, 
    ...
    while remaining_candidates>0: #Loop until new population has reached the desired size
        ...
        if reproduction_type==0: #Cross-over
            ...
            cross_over_type = jrandom.choice(new_key2, jnp.arange(3), p=jnp.array([0.0 if jnp.sum(layer_sizes) > 1 else 0,0.4,0.4]))    
            ...
            child = mutation.mutate_trees(parent, layer_sizes, new_key, reproduction_probability, mutation_probabilities, 
